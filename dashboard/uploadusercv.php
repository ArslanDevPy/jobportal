                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="fileToUpload">Select CV </label> <small class="pl-5"><?php if (isset($_SESSION['user_cv'])) { ?>
                                        <a href="media/user/cv/<?= $_SESSION['user_cv'] ?>" download>Download</a><?php } ?></small>
