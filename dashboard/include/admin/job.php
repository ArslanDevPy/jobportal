...
<div class="container py-3 my-3">
    ...
    <div class="d-flex">
        ...
        <div>
            <a href="http://localhost/jobportal/dashboard/addjob.php" class="btn btn-primary mb-3">New</a>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $rows['job_startdate'] ?></td>
                                <td><?= $rows['job_enddate'] ?></td>
                                <td>
                                    <a href="http://localhost/jobportal/dashboard/editjob.php?id=<?= $rows['id'] ?>" class="text-center btn btn-outline-primary btn-sm">
                                    ...
                                    <a href="http://localhost/jobportal/dashboard/code/job/deljob.php?id=<?= $rows['id'] ?>" class="text-center btn btn-outline-danger btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current width-5 height-5" viewBox="0 0 400 400">
                                            <g xmlns="http://www.w3.org/2000/svg">
                                                <g>
