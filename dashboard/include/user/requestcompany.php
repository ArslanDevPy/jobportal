<div class="container py-3 my-3">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header align-items-center">
            <form action="http://localhost/jobportal/dashboard/code/reqcompany/requestcompany.php" class="p-3" method="post">
                <div class="input-group mb-3">
                    <textarea required name="message" id="" cols="30" class="form-control" placeholder="Message" rows="10"></textarea>
                </div>
                <div class="col text-center">
                    <input type="submit" class="btn btn-outline-primary pl-3 pr-3 mt-3" value="<?php echo $page ?>">
                </div>
            </form>
        </div>
    </div>
